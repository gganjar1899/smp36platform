...
const menuGroups = [
  {
    ...
    items: [
      ...
      { href: '/dashboard/guru/tugas', label: 'Kelola Tugas', exact: false, icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-4 9l2 2 4-4"/></svg>
      )},
      { href: '/dashboard/guru/pengumuman', label: 'Pengumuman', exact: false, icon: (
        ...
        <header className="h-16 bg-white border-b border-gray-100 px-4 lg:px-6 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3 lg:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-gray-800 truncate">Portal Guru — SMPN 36</p>
