...
export default function NilaiLegerPage() {
  ...
  const handleExportExcel = () => {
    ...
    const headerRows = [
      ...
      ['Guru                 : ' + GURU_NAMA, '', '', '', '', '', '', '', '', '', '', `Wali Kelas   : ${GURU_NAMA}`],
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{GURU_NAMA} · {tahunAjaran}</p>
        </div>
            ...
            <div className="flex flex-wrap gap-4 items-end">
              <div>
                ...
                <select value={kelas} onChange={e => setKelas(e.target.value)}
                  ...
                  {['IX-A','IX-B','IX-C','IX-D','IX-E','IX-F','IX-G','VIII-A','VIII-B','VIII-C','VIII-D','VIII-E'].map(k => (
